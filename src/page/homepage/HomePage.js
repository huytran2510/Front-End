            ...
            <div style={pageStyle}>
                ...
                <div className={"container d-flex flex-row flex-wrap menu-home"}>
                    <div class="menu_item menu_banner">
                        <a>
                            <img src={"https://file.hstatic.net/1000075078/file/banner_app.jpg"}/>
                        </a>
                    </div>
                    <div class="menu_item">
                        <div className={"menu_item_image"}>
                            <a>
                                <img
                                    src={"https://product.hstatic.net/1000075078/product/1669736893_hi-tea-vai_7057577f3717414db7e0255646263516_large.png"}/>
                            </a>
                        </div>
                        <div className="menu_item_info">
                            <h3><a href="/products/bo-sua-pho-mai-tuoi" title="Bơ Sữa Phô Mai Tươi">Bơ Sữa Phô Mai Tươi</a></h3>
                ...
                <div className="section_1 container flex-wrap d-flex align-items-end justify-content-end flex-row">
                    ...
                    <div class="menu_content" data-aos = "fade-right">
                        <div>
                            <img src={"https://file.hstatic.net/1000075078/file/tagline__1__1_378410beecb347f38cf8425ef7459690.png"}/>
                        </div>
